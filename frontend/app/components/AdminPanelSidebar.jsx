      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul className="space-y-2 font-medium mt-4">
            <li>
              <Link href="/admin" className="flex items-center my-4">
                <img
            ...
            <li>
              ...
              >
                ...
                <span className="ms-3">Category Manager</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                ...
                <span className="ms-3">Product Manager</span>
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                ...
                <span className="ms-3">Order Manager</span>
              </Link>
            </li>
            <li>
