...
const ProductDetaiPage = async ({ params }) => {
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
          ...
          <div className="mt-6 sm:mt-8 lg:mt-0">
            ...
            <div className="flex flex-row my-4">
              <button className="size-btn mr-2">XS</button>
              <button className="size-btn mr-2">S</button>
              <button className="size-btn mr-2">M</button>
              <button className="size-btn mr-2">L</button>
